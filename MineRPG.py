...
loadgame = ['Load saved game?','New Game','Load Saved Game']
...
def draw_intro():
    if state == 'INTRO':
        ...
        draw_text_box(loadgame[1],50,stage_rects[4].center, RED)
        draw_text_box(loadgame[2],50,stage_rects[5].center, RED)
        draw_text_box(loadgame[0], 50, stage_rects[6].center, RED)
...
def draw_text_box(drawntext,fontsize,textlocation,color):
    boxtext = drawntext
    ...
    return newrenderedrect #Rect to click. For location, will just do .center
...
def set_stage_icon_rects():
    ...
    if state == 'INTRO':
        new_game_prompt = draw_text_box(loadgame[0],50,(WINDOW_WIDTH-400,WINDOW_HEIGHT-300), RED)
        new_game_rect = draw_text_box(loadgame[1],50,(WINDOW_WIDTH-600,WINDOW_HEIGHT-200), RED)
        load_game_rect = draw_text_box(loadgame[2],50,(WINDOW_WIDTH-250,WINDOW_HEIGHT-200), RED)
